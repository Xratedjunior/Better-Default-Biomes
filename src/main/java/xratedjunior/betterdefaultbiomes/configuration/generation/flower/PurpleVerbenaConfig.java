 ...
 */
public class PurpleVerbenaConfig {
	...
	public static String featureName = "Purple Verbena";
	private static int defaultCount = 20;
	private static List<String> generationBiomes = Lists.newArrayList("forest", "minecraft:plains");
