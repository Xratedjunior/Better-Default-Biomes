 ...
 */
public class FeatherReedGrassConfig {
	...
	public static String featureName = "Feather Reed Grass";
	private static int defaultCount = 120;
	private static List<String> generationBiomes = Lists.newArrayList("jungle", "plains", "savanna", "minecraft:beach", "forest", "minecraft:river", "swamp");
