 ...
 */
public class SwampWillowTreeConfig {
	...
	private static String featureName = "Swamp Willow Tree";
	private static int defaultCount = 1000;

	private static List<String> generationBiomes = Lists.newArrayList("swamp");
